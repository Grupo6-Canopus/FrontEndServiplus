...
const FormEmpleados = () => {
    ...
    const cambiarRolAdministrador = (event) => {
        setRolAdministrador(event.target.value);
    };
        ...
        <div className="container mt-3">
            ...
            <div>
                ...
                <form className="container" action="">
                    ...
                    <div className="row">
                        <div className="col-3">
                            <label className="form-control-sm" htmlFor="cargo">
                                Cargo *
                            </label>
                            <input
                                className="form-control form-control-sm"
                    ...
                    <div className="row">
                        <div className="col-3">
                            <label className="form-control-sm" htmlFor="area">
                                Área *
                            </label>
                            <input
                                className="form-control form-control-sm"
                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                            <label className="form-control-sm" htmlFor="rolAdministrador">
                                Rol *
                            </label>
                            <input
                                className="form-control form-control-sm"
                                type="rolAdministrador"
                                onChange={cambiarRolAdministrador}
                                value={rolAdministrador}
                        ...
                        <div className="col-3">
                            <label className="form-control-sm" htmlFor="password">
                                Contraseña *
                            </label>
                            <input
                                className="form-control form-control-sm"
